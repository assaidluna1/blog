		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info">
            	...
            	<div class="credit-info">
                    ...
                    <?php printf( __( ', Theme', 'i-max' )); ?> 
                    <a href="<?php echo esc_url( __( 'http://www.templatesnext.org/i-max/', 'i-max' ) ); ?>" title="<?php esc_attr_e( 'Multi-purpose WordPress WooCommerce Theme', 'i-max' ); ?>" rel="designer">
                   		<?php printf( __( 'i-max', 'i-max' ) ); ?>
                    </a>
					<?php printf( __( ' by TemplatesNext.', 'i-max' )); ?>                     
                </div>
